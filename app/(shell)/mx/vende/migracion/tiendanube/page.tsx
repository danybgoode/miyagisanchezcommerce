...
import { buildMigracionTiendanubePageConfig } from '../../_components/page-config'

const BASE_URL = 'https://miyagisanchez.com'
const PAGE_PATH = '/mx/vende/migracion/tiendanube'

const meta = es.sellerAcquisition.migracionTiendanube.metadata
...
export default async function MigracionTiendanubePage() {
  const ui = (await getOverriddenDictionary('es')).sellerAcquisition
  const config = buildMigracionTiendanubePageConfig(ui)
  ...
  const jsonLd = {
    ...
    potentialAction: {
      '@type': 'CreateAction',
      name: ui.migracionTiendanube.primaryCta,
