...
import { buildMigracionWoocommercePageConfig } from '../../_components/page-config'

const BASE_URL = 'https://miyagisanchez.com'
const PAGE_PATH = '/mx/vende/migracion/woocommerce'

const meta = es.sellerAcquisition.migracionWoocommerce.metadata
...
export default async function MigracionWoocommercePage() {
  const ui = (await getOverriddenDictionary('es')).sellerAcquisition
  const config = buildMigracionWoocommercePageConfig(ui)
  ...
  const jsonLd = {
    ...
    potentialAction: {
      '@type': 'CreateAction',
      name: ui.migracionWoocommerce.primaryCta,
