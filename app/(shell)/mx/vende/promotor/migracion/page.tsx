 ...
 * `/mx/vende/promotor/sell-sheet` (injected <style>, `.no-print` toolbar, noindex), but
  ...
  return (
    <main className="ss-root">
      ...
      <div className="no-print" style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
        <a href="/mx/vende/promotor/sell-sheet" style={{ textDecoration: 'underline', fontSize: 14 }}>← Volver al manual del promotor</a>
