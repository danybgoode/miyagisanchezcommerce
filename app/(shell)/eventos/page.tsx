...
import EventsIndexBody from '../_shop-sections/EventsIndexBody'
import type { Metadata } from 'next'

/**
 * Living Shop — the "eventos" section on an OWNED host (epic 07, Sprint 3).
 *
 ...
 * and 404s without a Medusa call — the marketplace form is `/s/[slug]/eventos`.
 */
...
export default async function ChannelSectionPage() {
  ...
  return <EventsIndexBody ctx={ctx} />
}
