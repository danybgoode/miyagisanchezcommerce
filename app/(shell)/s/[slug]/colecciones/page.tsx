...
import CollectionsIndexBody from '@/app/(shell)/_shop-sections/CollectionsIndexBody'
import type { Metadata } from 'next'

/**
 * Living Shop — the "colecciones" section on the MARKETPLACE host (epic 07, Sprint 3).
 *
