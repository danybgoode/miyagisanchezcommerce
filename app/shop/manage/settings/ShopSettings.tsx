...
import { PRESETS, parseLocation, detectSchedulingService, generateHex32, ENVIA_CARRIERS } from '@/lib/shop-settings/helpers'
...
// ENVIA_CARRIERS moved to lib/shop-settings/helpers.ts — imported above.
...
// CopyPromptButton + PickupSpotManager promoted to ./_components/ — imported
// above so the extracted sections reuse the exact same primitives.
