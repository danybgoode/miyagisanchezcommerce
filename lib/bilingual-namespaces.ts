 ...
 * operator activation, invitation email and operator-only `/partner` orientation,
 * defaulting to English with an explicit Spanish toggle). `sellerAcquisition` is es-only by deliberate
